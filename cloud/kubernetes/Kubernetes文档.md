...
+ https://kubernetes.io/docs/tasks/tools/included/verify-kubectl
+ https://kubernetes.io/docs/tasks/tools/included/kubectl-whats-next
...
+ https://kubernetes.io/docs/tasks/administer-cluster/enabling-topology-aware-hints
...
+ https://kubernetes.io/docs/reference/kubernetes-api/config-and-storage-resources/csi-storage-capacity-v1beta1
...
+ https://kubernetes.io/docs/reference/kubernetes-api/cluster-resources/flow-schema-v1beta1
+ https://kubernetes.io/docs/reference/kubernetes-api/cluster-resources/priority-level-configuration-v1beta1
...
+ https://kubernetes.io/docs/reference/config-api/kube-scheduler-config.v1beta1
